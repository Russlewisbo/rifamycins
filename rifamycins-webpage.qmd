...
The rifamycins belong to the ansamycin family (from the Latin *ansa*, "handle") because of their basket-like structure: an aliphatic chain bridging two ends of a naphthoquinone core. Rifampin is the 3-(4-methyl-1-piperazinyl)-iminomethyl derivative of rifamycin SV.
...
Rifampin killing of *M. tuberculosis* is concentration-dependent and correlates with the AUC/MIC ratio [@Gumbo2007; @Jayaram2003]. Early-bactericidal-activity and dose-ranging studies show that **higher doses** (up to 35 mg/kg) are safe and shorten time to culture conversion, raising the prospect of shorter regimens [@Boeree2015; @Boeree2017].
...
For **prosthetic valve endocarditis** caused by staphylococci, rifampin remains part of triple therapy (e.g., vancomycin + rifampin + gentamicin) [@Karchmer1983].
...
<!-- IMAGE NEEDED: Structures of the four major rifamycins (rifampin, rifabutin, rifapentine, rifaximin) — Fig. 26.1 equivalent. Do not reproduce copyrighted figure; a redrawn ansamycin scaffold schematic would suffice. -->

<!-- IMAGE NEEDED: Schematic of rifampin binding the RNAP β-subunit within the DNA/RNA channel (steric-occlusion model). -->
